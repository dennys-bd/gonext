...
This document is the **vision**: philosophy, architecture, and the full catalog of what gonext can generate. For build status, what's implemented vs. pending, and prioritized next steps, see [roadmap.md](./roadmap.md).
...
Build status for every box in this diagram — what's implemented vs. pending — lives in [roadmap.md](./roadmap.md).
...
| *Future direction* | *Live service visibility* | *Tracked in roadmap.md as a deferred gap: turning this static, offline graph into a live view of the running service (Encore.dev-style), once the pack itself exists.* |
