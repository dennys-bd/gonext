...
- `docs/superpowers/specs/` and `docs/superpowers/plans/` are local-only (gitignored) design/planning artifacts from the `/plan` and brainstorming workflow — not published, not a substitute for `roadmap.md` or the board.
